            ...
            <div className={styles.Right}>
              <div className={styles.WorkText}>
                ...
                <p>
                  ...
                  manage their clients and operate their day-to-day activities.
                  As part of my internship, I created the entire company
                  website, from wireframing and mockups to development. I also
                  built various main features of the web app.
                </p>
          ...
          <>
            <div className={styles.Left}>
              <div className={styles.WorkText}>
                ...
                <h2>Shoppies</h2>
                <p>
                  The Shoppies is movie awards app where users can search for a
                  movie, read its information and add/remove 5 movie
                  nominations. For this fun challenge, I fetched the OMDB’s API
                  to display the movies posters and information.
                </p>
            ...
            <div className={styles.Right}>
              <div className={styles.WorkText}>
                ...
                <p>
                  ...
                  because this is where I first learned to use Figma HTML & CSS.
                  This portfolio displays some of my older projects.
                </p>
